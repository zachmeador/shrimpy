...
export const CLI_COMMAND_CATALOG: readonly CliCommandEntry[] = [
  ...
  entry(["sessions", "thinking"], "<session-id> <level> [--agent <id>] [--no-wait] [--json]", "Change reasoning effort for a running session.", "Session Commands", [agentOption, { name: "--no-wait" }, jsonOption]),
