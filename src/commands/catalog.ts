...
export const CLI_COMMAND_CATALOG: readonly CliCommandEntry[] = [
  ...
  entry(["skills", "add"], "<source> [--agent <id>|--workspace] [--id <id>] [--path <path>] [--ref <ref>] [--all] [--dry-run] [--force] [--json]", "Discover, fetch, or copy a skill package and bind it to an agent or workspace.", "Agents, Skills, Users", [agentOption, { name: "--workspace" }, { name: "--id", takesValue: true }, { name: "--path", takesValue: true }, { name: "--ref", takesValue: true }, { name: "--all" }, { name: "--dry-run" }, { name: "--force" }, jsonOption]),
  entry(["skills", "update"], "<id> [--dry-run] [--json]", "Check and update a managed skill package from its recorded source.", "Agents, Skills, Users", [{ name: "--dry-run" }, jsonOption]),
  entry(["skills", "bind"], "<id> [--agent <id>|--workspace] [--json]", "Enable an installed skill package for an agent or the workspace.", "Agents, Skills, Users", [agentOption, { name: "--workspace" }, jsonOption]),
  entry(["skills", "unbind"], "<id> [--agent <id>|--workspace] [--json]", "Disable an installed skill package for an agent or the workspace without deleting it.", "Agents, Skills, Users", [agentOption, { name: "--workspace" }, jsonOption]),
