...
export const CLI_COMMAND_CATALOG: readonly CliCommandEntry[] = [
  ...
  entry(["watches", "add"], "<id> [--agent <id>] (--cron <expr>|--every <dur>|--every-ms <n>) (--channel <name> --message <text>|--command <cmd>) [--json]", "Add an agent-owned watch.", "Workspace And Runtime", [agentOption, { name: "--name", takesValue: true }, { name: "--cron", takesValue: true }, { name: "--every", takesValue: true }, { name: "--every-ms", takesValue: true }, { name: "--timezone", takesValue: true }, { name: "--channel", takesValue: true }, { name: "--message", takesValue: true }, { name: "--addressed", takesValue: true }, { name: "--command", takesValue: true }, { name: "--cwd", takesValue: true }, { name: "--timeout-ms", takesValue: true }, { name: "--emit-policy", takesValue: true }, { name: "--emit-channel", takesValue: true }, { name: "--emit-template", takesValue: true }, { name: "--disabled" }, jsonOption]),
