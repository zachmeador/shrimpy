...
export const CLI_COMMAND_CATALOG: readonly CliCommandEntry[] = [
  ...
  entry(["skills", "add"], "<source> [--agent <id>|--workspace] [--id <id>] [--path <path>] [--ref <ref>] [--all] [--dry-run] [--force] [--json]", "Discover, fetch, or copy a skill package into an agent or workspace skill root.", "Agents, Skills, Users", [agentOption, { name: "--workspace" }, { name: "--id", takesValue: true }, { name: "--path", takesValue: true }, { name: "--ref", takesValue: true }, { name: "--all" }, { name: "--dry-run" }, { name: "--force" }, jsonOption]),
