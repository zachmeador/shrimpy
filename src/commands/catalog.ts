...
export const CLI_COMMAND_CATALOG: readonly CliCommandEntry[] = [
  ...
  entry(["skills", "add"], "<source> [--agent <id>|--workspace] [--id <id>] [--force]", "Fetch or copy a skill package and bind it to an agent or workspace.", "Agents, Skills, Users", [agentOption, { name: "--workspace" }, { name: "--id", takesValue: true }, { name: "--force" }]),
