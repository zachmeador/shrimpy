...
The mechanic is caretaker of the Shrimpy environment and builder/maintainer for apps and flows inside it.
...
- **Agent**: scoped collaborator, context boundary, identity, memory, TUI sessions.
...
Prefer the smaller owner unless the user wants a scoped collaborator or the domain should not bleed into the base agent.
