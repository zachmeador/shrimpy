...
Priority: P3
Area: Agents
Depends On: [APP-001](../app-001.md), [CTX-008](ctx-008-runtime-context-producers.md)
...
- [APP-001](../app-001.md): app/config examples can later include a clearly optional nested character-agent habitat.
