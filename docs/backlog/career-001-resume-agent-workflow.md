...
- This can serve as the first serious app-agent example after [SKILL-001](skill-001-shrimpy-search-skill.md) establishes all-agent search-before-invent guidance and focused skills own workflow actions.
