...
|---|---|---|---|---|---|
| [ARCH-001](proposals/arch-001-shrimpy-runtime-kernel.md) | draft | P1 | Architecture | none | Process-independent runtime kernel with transactional state, shared session execution, and optional hosts |
