...
|---|---|---|---|---|---|
| [CTX-003](ctx-003.md) | done | P1 | Context | none | High-value turn briefing facts |
...
| [MODELS-002](models-002.md) | done | P1 | Models | none | Agent model defaults and resolution inspection |
...
| [TUI-002](tui-002-ctrl-o-tool-expansion.md) | done | P1 | TUI | none | Ctrl+O tool expansion regression |
| [TUI-003](tui-003-slash-command-output-ux.md) | done | P2 | TUI | [TUI-001](tui-001.md) | Slash command output UX polish |
...
| [SURFACE-003](surface-003-chat-agent-switching.md) | done | P1 | Surfaces | none | Chat agent switching bug |
