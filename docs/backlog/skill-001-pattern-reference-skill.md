...
- A neighboring backlog note owns the deep version of one pattern: [MECH-002](mech-002-audit-skills.md) (mechanic security and hygiene audit skills).
...
- Do not implement the audit skills or vault git tracking here. Those remain [MECH-002](mech-002-audit-skills.md) and [VAULT-001](vault-001-default-workspace-collections.md).
...
- MECH-002's hygiene checklist is complementary, not duplicate: it says what tends to go wrong; this skill says what shapes to reach for. Keep them separate.
