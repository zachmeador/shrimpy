...
- Related setup behavior: provider/model bootstrap and guided setup are already part of `shrimpy setup`.
- Later-scope security follow-up: [SECURITY-001](security-001-agent-sandboxing-security-strategy.md).
- Likely files: `README.md`, `docs/README.md`, `docs/reference/README.md`, a new stable setup/install doc under `docs/reference/`, `src/gateway-ctl.ts`, `src/commands/gateway.ts`, `src/commands/status.ts`, `src/setup/init.ts`, `src/setup/telegram.ts`, and setup template resources.
