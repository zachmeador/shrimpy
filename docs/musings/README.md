...
Start with `docs/reference/` first, and use `docs/backlog/` for the now/soon queue or `docs/backlog/proposals/` for unscheduled product directions. Come here when you want more design context, unfinished thinking, or the original vibe behind a direction.
